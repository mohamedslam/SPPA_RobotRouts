...
namespace WinApp_GraphicInterface.Forms.DrawAreaPlan
{
    public partial class FlowSharpUI : Form
    {
        ...
        protected Class.DrawArea.TraceListener traceListener;
        ...
        public FlowSharpUI(AreaProperitesModel areaProperites)
        {
        ...
        protected void InitializeCanvas()
		{
			...
			canvas = new Canvas(AreaProperites);
            ...
            toolboxCanvas = new ToolboxCanvas(AreaProperites);
        }
